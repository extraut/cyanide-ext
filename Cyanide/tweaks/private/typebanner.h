...
NSString * _Nullable typebanner_poll_in_imagent_remote_session(RemoteCallSession * _Nonnull session);
bool typebanner_show_in_springboard_remote_session(RemoteCallSession * _Nonnull session, NSString * _Nonnull label);
#endif
#endif
